...
<div class="score-list-report {{ $scorePrintLayout ? 'score-list-print-layout' : '' }}">
    @if($scorePrintLayout)
        <div class="score-list-heading">
            ...
            <div class="score-list-right">
                <div class="score-list-motto"><div class="score-list-motto-kh">&#x1796;&#x17D2;&#x179A;&#x17C7;&#x179A;&#x17B6;&#x1787;&#x17B6;&#x178E;&#x17B6;&#x1785;&#x1780;&#x17D2;&#x179A;&#x1780;&#x1798;&#x17D2;&#x1796;&#x17BB;&#x1787;&#x17B6;</div><div class="score-list-motto-kh">&#x1787;&#x17B6;&#x178F;&#x17B7; &#x179F;&#x17B6;&#x179F;&#x1793;&#x17B6; &#x1796;&#x17D2;&#x179A;&#x17C7;&#x1798;&#x17A0;&#x17B6;&#x1780;&#x17D2;&#x179F;&#x178F;&#x17D2;&#x179A;</div><div class="score-list-motto-en">KINGDOM OF CAMBODIA</div><div class="score-list-motto-en">NATION RELIGION KING</div></div>
    ...
    @endif
    @if($scorePrintLayout)
        <div class="score-list-print-title"><div class="score-list-print-title-kh">&#x178F;&#x17B6;&#x179A;&#x17B6;&#x1784;&#x179F;&#x1798;&#x17D2;&#x179A;&#x1784;&#x17CB;&#x1796;&#x17B7;&#x1793;&#x17D2;&#x1791;&#x17BB;</div><div class="score-list-print-title-en">Score List</div></div>
        <div class="score-list-print-info-row"><span class="score-print-info-label"><span class="score-print-info-label-kh">&#x1788;&#x17D2;&#x1798;&#x17C4;&#x17C7;&#x1782;&#x17D2;&#x179A;&#x17BC;</span><span class="score-print-info-label-en">Teacher Name:</span></span><span class="score-print-info-line"></span><span class="score-print-info-label"><span class="score-print-info-label-kh">&#x1798;&#x17BB;&#x1781;&#x179C;&#x17B7;&#x1787;&#x17D2;&#x1787;&#x17B6;</span><span class="score-print-info-label-en">Subject:</span></span><span class="score-print-info-line"></span><span class="score-print-info-label"><span class="score-print-info-label-kh">&#x1790;&#x17D2;&#x1793;&#x17B6;&#x1780;&#x17CB;&#x1791;&#x17B8;</span><span class="score-print-info-label-en">Grade:</span></span><span class="score-print-info-line score-print-info-value">{{ $scoreGradeLabel ?: '-' }}</span><span class="score-print-info-label"><span class="score-print-info-label-kh">&#x179F;&#x1798;&#x17D2;&#x179A;&#x17B6;&#x1794;&#x17CB;</span><span class="score-print-info-label-en">For:</span></span><span class="score-print-info-line score-print-info-value">{{ $scorePrintType }}</span></div>
    ...
    <table class="score-list-table">
        <thead>
            <tr>
                ...
                <th colspan="3" class="score-section-col score-monthly-test-col"><span>&#x178F;&#x17C1;&#x179F;&#x17D2;&#x178F;&#x1794;&#x17D2;&#x179A;&#x1785;&#x17B6;&#x17C6;&#x1781;&#x17C2;</span>Monthly Test</th>
            </tr>
            <tr>
    ...
    @if($scorePrintLayout)
        <div class="score-list-footer">
            <div class="score-list-note-kh khmer-font-siemreap">&#x1785;&#x17C6;&#x178E;&#x17B6;&#x17C6;&#x17D6; &#x178F;&#x17B6;&#x179A;&#x17B6;&#x1784;&#x179F;&#x1798;&#x17D2;&#x179A;&#x1784;&#x17CB;&#x1796;&#x17B7;&#x1793;&#x17D2;&#x1791;&#x17BB;&#x1793;&#x17C1;&#x17C7; &#x1782;&#x17BA;&#x179F;&#x1798;&#x17D2;&#x179A;&#x17B6;&#x1794;&#x17CB;&#x179B;&#x17C4;&#x1780;&#x1782;&#x17D2;&#x179A;&#x17BC;&#x17A2;&#x17D2;&#x1793;&#x1780;&#x1782;&#x17D2;&#x179A;&#x17BC;&#x1780;&#x178F;&#x17CB;&#x1796;&#x17B7;&#x1793;&#x17D2;&#x1791;&#x17BB;&#x1785;&#x17BC;&#x179B; &#x178A;&#x17BE;&#x1798;&#x17D2;&#x1794;&#x17B8;&#x1784;&#x17B6;&#x1799;&#x179F;&#x17D2;&#x179A;&#x17BD;&#x179B;&#x1780;&#x17D2;&#x1793;&#x17BB;&#x1784;&#x1780;&#x17B6;&#x179A;&#x1780;&#x178F;&#x17CB;&#x1796;&#x17B7;&#x1793;&#x17D2;&#x1791;&#x17BB;&#x1785;&#x17BC;&#x179B;&#x1780;&#x17D2;&#x1793;&#x17BB;&#x1784;&#x178F;&#x17B6;&#x179A;&#x17B6;&#x1784;&#x179F;&#x1798;&#x17D2;&#x179A;&#x1784;&#x17CB;&#x1796;&#x17B7;&#x1793;&#x17D2;&#x1791;&#x17BB;&#x17A2;&#x17C1;&#x17A1;&#x17B7;&#x1785;&#x178F;&#x17D2;&#x179A;&#x17BC;&#x1793;&#x17B7;&#x1785; (E-Gradebook)&#x17D4;</div>
<div class="score-list-note-kh score-list-note-kh-secondary khmer-font-siemreap">&#x178F;&#x17B6;&#x179A;&#x17B6;&#x1784;&#x179F;&#x1798;&#x17D2;&#x179A;&#x1784;&#x17CB;&#x1796;&#x17B7;&#x1793;&#x17D2;&#x1791;&#x17BB;&#x1793;&#x17C1;&#x17C7;&#x1782;&#x17BA;&#x1794;&#x17D2;&#x179A;&#x17BE;&#x1794;&#x17D2;&#x179A;&#x17B6;&#x179F;&#x17CB;&#x179F;&#x1798;&#x17D2;&#x179A;&#x17B6;&#x1794;&#x17CB;&#x1792;&#x17D2;&#x179C;&#x17BE;&#x1780;&#x17B6;&#x179A;&#x1780;&#x178F;&#x17CB;&#x178F;&#x17D2;&#x179A;&#x17B6;&#x1795;&#x17D2;&#x1791;&#x17B6;&#x179B;&#x17CB;&#x1781;&#x17D2;&#x179B;&#x17BD;&#x1793;&#x179A;&#x1794;&#x179F;&#x17CB;&#x179B;&#x17C4;&#x1780;&#x1782;&#x17D2;&#x179A;&#x17BC;&#x17A2;&#x17D2;&#x1793;&#x1780;&#x1782;&#x17D2;&#x179A;&#x17BC;&#x178F;&#x17C2;&#x1794;&#x17C9;&#x17BB;&#x178E;&#x17D2;&#x178E;&#x17C4;&#x17C7;&#x17D4;</div>
            <div class="score-list-note-en"><div>* NOTE: This list is for teachers to keep record of all kinds of scores which is served as hard copies for egrade-book input.</div><div class="score-list-note-en-secondary">The list is for teacher personal use. It is not required by the office.</div></div>
