                ...
                <div class="card-body">
                    ...
                    <div class="row g-4">
                                    ...
                                    <div class="logo-dropzone branding-dropzone flex-fill" data-branding-dropzone="{{ $field }}"
                                        ...
                                        <div class="branding-preview-wrap {{ $branding->{$path} ? '' : 'd-none' }}"
                                            ...
                                            <img src="{{ $branding->{$path} ? asset('storage/' . $branding->{$path}) : '#' }}"
                                                alt="{{ $label }} preview"
                                                data-branding-preview="{{ $field }}">
                                        </div>
                                    </div>
                                </div>
                                @if ($branding->{$path})
                                    <label class="form-check mt-2"><input type="checkbox" name="remove_{{ $field }}"
                                            value="1" class="form-check-input"><span
                                            class="form-check-label text-danger">Remove current
                                            {{ strtolower($label) }}</span></label>
                                @endif
                        ...
                        <div class="col-12">
                            ...
                            <input name="footer_text" class="form-control" maxlength="255"
