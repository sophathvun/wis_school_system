    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <button type="button" id="btnPrintSchoolProfiles"
                        class="btn btn-secondary btn-5 d-none d-sm-inline-block"><i class="ti ti-printer icon"></i>
                        Print</button>
                    <a href="{{ route('schoolInfo.excel') }}"
                        class="btn btn-outline-success btn-5 d-none d-sm-inline-block"><i
                            class="ti ti-file-spreadsheet icon"></i> Excel</a>
                    <button id="btnNewSchoolProfile" type="button" data-bs-toggle="modal"
                        data-bs-target="#schoolProfileModal" class="btn btn-primary btn-5 d-none d-sm-inline-block"><i
                            class="ti ti-plus icon"></i> New School Profile</button>
                    <button id="btnNewSchoolProfileMobile" type="button" data-bs-toggle="modal"
                        data-bs-target="#schoolProfileModal" class="btn btn-primary btn-6 d-sm-none btn-icon"><i
                            class="ti ti-plus icon"></i></button>
                </div>
            </div>
        </div>
    </div>
...
@section('content')
                ...
                <div class="row col-12 g-2 align-items-center justify-content-end">
                    <div class="col-auto">
                        <div class="input-icon"><span class="input-icon-addon"><i
                                    class="ti ti-search icon"></i></span><input type="text" id="school-profiles-search"
                                class="form-control form-control-sm" placeholder="Search school profiles"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal modal-blur fade" id="schoolProfileModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form id="schoolProfileForm" novalidate>
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="schoolProfileModalTitle">Create School Profile</h5><button
                    ...
                    <div class="modal-footer"><button type="button" class="btn me-auto"
                            data-bs-dismiss="modal">Close</button><button type="submit" id="schoolProfileSubmitBtn"
    ...
    <div class="modal modal-blur fade" id="schoolProfileViewModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">View School Profile</h5><button type="button" class="btn-close"
                        data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="text-center mb-4"><img id="viewSchoolLogo" src="" alt="School Logo" class="d-none"
                            style="width:110px;height:110px;object-fit:contain"></div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="text-secondary">School Name (Khmer)</div>
                            <div id="viewSchoolNameKh" class="school-profile-khmer fs-3"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="text-secondary">School Name (English)</div>
                            <div id="viewSchoolNameEn" class="fs-3"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="text-secondary">Campus (Khmer)</div>
                            <div id="viewCampusNameKh" class="school-profile-khmer fs-3"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="text-secondary">Campus (English)</div>
                            <div id="viewCampusNameEn" class="fs-3"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="text-secondary">Phone Number</div>
                            <div id="viewPhone" class="fs-3"></div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <div id="viewAddress" class="text-wrap"></div>
                        </div>
                        <div class="col-12">
                            <div class="text-secondary">Google Map Link</div>
                        ...
                        <div class="col-12">
                            ...
                            <div id="viewDescription" class="text-wrap"></div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer"><button type="button" class="btn me-auto"
                        data-bs-dismiss="modal">Close</button><button type="button" id="viewSchoolPrintBtn"
                        class="btn btn-primary"><i class="ti ti-printer icon"></i>Print</button></div>
            </div>
        </div>
    </div>
