    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <button id="btnNewSession" type="button" class="btn btn-primary btn-5 d-none d-sm-inline-block"><i
                            class="ti ti-plus icon"></i> New Session</button>
                    <button id="btnNewSessionMobile" type="button" class="btn btn-primary btn-6 d-sm-none btn-icon"><i
...
@section('content')
                ...
                <div class="row col-12 g-2 align-items-center justify-content-end">
                    <div class="col-auto">
                        <div class="input-icon"><span class="input-icon-addon"><i
                                    class="ti ti-search icon"></i></span><input type="text" id="sessions-search"
                                class="form-control form-control-sm" placeholder="Search sessions"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal modal-blur fade" id="sessionModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 460px;">
            <div class="modal-content">
                <form id="sessionForm" novalidate>
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="sessionModalTitle">Create Session</h5><button type="button"
                    ...
                    <div class="modal-footer"><button type="button" class="btn me-auto"
                            data-bs-dismiss="modal">Close</button><button type="submit" id="sessionSubmitBtn"
