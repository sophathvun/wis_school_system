...
<head>
    <meta charset="UTF-8">
    <title>Withdrawal Reason List</title>
    <style>
        @font-face {
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="khmer-font">Reason (Khmer)</th>
                <th>System Key</th>
                <th>Status</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($reasons as $index => $reason)
                <tr>
                    ...
                    <td class="khmer-font">{{ $reason->name_kh ?: '-' }}</td>
                    <td>{{ $reason->reason_key ?: '-' }}</td>
                    <td>{{ $reason->status ? 'Active' : 'Inactive' }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
