...
.profile-fields-left > .col-md-6 .form-control { height: 52px; min-height: 52px; padding: 1.25rem 1rem .35rem; border: 1.5px solid #dfe3ea; border-radius: 14px; background: var(--tblr-bg-surface, #fff); box-shadow: 0 2px 7px rgba(31, 41, 55, .04); }
</style>
<script>
document.addEventListener('DOMContentLoaded', () => {
