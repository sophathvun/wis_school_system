    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <button type="button" id="btnPrintClasses"
                        class="btn btn-secondary btn-5 d-none d-sm-inline-block"><i class="ti ti-printer icon"></i>
                        Print</button>
                    <a href="{{ route('classes.excel') }}" class="btn btn-outline-success btn-5 d-none d-sm-inline-block"><i
                            class="ti ti-file-spreadsheet icon"></i> Excel</a>
                    <button id="btnNewClass" type="button" class="btn btn-primary btn-5 d-none d-sm-inline-block"><i
                            class="ti ti-plus icon"></i> New Class</button>
                    <button id="btnNewClassMobile" type="button" class="btn btn-primary btn-6 d-sm-none btn-icon"><i
...
@section('content')
            ...
            <div class="table-responsive table-vcenter text-nowrap">
                <table class="table card-table">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th><button type="button" class="table-sort" data-sort="class_name">Class Name</button></th>
                            <th><button type="button" class="table-sort" data-sort="class_order">Order</button></th>
    ...
    <div class="modal modal-blur fade" id="classModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 460px;">
            <div class="modal-content">
                <form id="classForm" novalidate>
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="classModalTitle">Create Class</h5><button type="button"
                            class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">@include('partials.class-form')</div>
                    <div class="modal-footer"><button type="button" class="btn me-auto"
                            data-bs-dismiss="modal">Close</button><button type="submit" id="classSubmitBtn"
