...
class EnrollmentWorkflowAction extends Model
{
    ...
    protected $fillable = [
        'student_id', 'source_enrollment_id', 'target_enrollment_id', 'parent_workflow_id', 'action_type', 'status',
        'from_campus_id', 'to_campus_id', 'from_academic_year_id', 'to_academic_year_id',
        'from_grade_id', 'to_grade_id', 'from_class_id', 'to_class_id',
        'from_session_id', 'to_session_id', 'effective_on', 'cancelled_at', 'cancelled_by', 'cancellation_reason', 'reason', 'notes', 'changed_by',
    ];
    ...
    public function parentWorkflow() { return $this->belongsTo(self::class, 'parent_workflow_id'); }
}
