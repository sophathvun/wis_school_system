...
class BrandingSetting extends Model
{
    ...
    protected $fillable = ['sidebar_logo_path', 'login_logo_path', 'shortcut_icon_path', 'favicon_path', 'footer_logo_path', 'report_logo_1_path', 'report_logo_2_path', 'footer_text'];
